...
if __name__ == '__main__':
    ...
    network1 = Network.Network.LoadNetwork('/home/marlon/loreleai/Neural2/network16.txt')
    #toc = time.perf_counter()
    #print(f"Downloaded the tutorial 2 in {toc - tic:0.10f} seconds")
    print(network1.GetNumOutputs())
    network2 = Network.Network.LoadNetwork('/home/marlon/loreleai/Neural2/network17.txt')
    print(network1.GetNumOutputs())
